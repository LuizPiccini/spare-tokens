Work on the public GitHub issue https://github.com/scipy/scipy/issues/7168.
...
3. Create a local branch such as codex/spare-tokens-scipy-scipy-issue-7168. Keep the diff narrow and tied to the issue.
