Work on the public GitHub issue https://github.com/openfoodfacts/openfoodfacts-server/issues/10182.
...
3. Create a local branch such as codex/spare-tokens-openfoodfacts-openfoodfacts-server-issue-10182. Keep the diff narrow and tied to the issue.
