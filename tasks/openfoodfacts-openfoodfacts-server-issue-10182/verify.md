...
```bash
curl -L https://api.github.com/repos/openfoodfacts/openfoodfacts-server/issues/10182
git ls-remote https://github.com/openfoodfacts/openfoodfacts-server.git HEAD
```
