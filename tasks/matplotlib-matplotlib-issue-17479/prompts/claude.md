Work on the public GitHub issue https://github.com/matplotlib/matplotlib/issues/17479.
...
3. Create a local branch such as codex/spare-tokens-matplotlib-matplotlib-issue-17479. Keep the diff narrow and tied to the issue.
